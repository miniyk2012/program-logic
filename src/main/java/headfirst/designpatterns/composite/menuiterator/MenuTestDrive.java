...
public class MenuTestDrive {
    ...
    private static void printVeges() {
    ...
    private static void printPreOrder() {
        ...
        MenuComponent c = new MenuItem("C", "c", false, 0);
        MenuComponent d = new MenuItem("D", "d", false, 0);
        MenuComponent e = new Menu("E", "e");
        MenuComponent f = new MenuItem("F", "f", false, 0);
